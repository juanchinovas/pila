...
export class PilaEditor {
  ...
  constructor(container: HTMLElement, options: EditorOptions = {}) {
    ...
    this.portalTo = this.resolvePortalTo(options.portalTo);
  }
  ...
  mount(): void {
    ...
    this.slashMenu = new SlashMenu(this.editorEl, this.manager, this.plugins, this.portalTo);
    this.floatingToolbar = new FloatingToolbar(this.editorEl, this.manager, this.plugins, this.portalTo);
    this.dragHandle = new DragHandle(this.editorEl, this.manager, this.portalTo);
