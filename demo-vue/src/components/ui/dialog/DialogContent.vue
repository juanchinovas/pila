  ...
  <DialogPortal>
    ...
    >
      <DialogContent
        ...
        :class="
          cn(
            'relative grid w-[calc(100vw-2rem)] max-w-lg gap-4 border border-border bg-background p-6 shadow-lg duration-200 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 sm:rounded-lg',
            props.class,
          )"
      >
        <slot />
